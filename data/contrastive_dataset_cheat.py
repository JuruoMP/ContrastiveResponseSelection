        ...
        if self.split == 'train':
            ...
            if random.random() < 0.5:
                ...
                if n_context_turns <= 2:
                    ...
                    negative_response = random.sample(self.input_examples, 1)[0].response
                else:
                ...
                positive_feature = self._example_to_feature(index, positive_example_contras)
                negative_feature = self._example_to_feature(index, negative_example_contras)
                positive_feature_aug = self._example_to_feature(index, positive_example_contras_aug)
                negative_feature_aug = self._example_to_feature(index, negative_example_contras_aug)
