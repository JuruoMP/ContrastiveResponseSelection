...
class CreateBertPretrainingData(object):
    def __init__(self, args):
        self.args = args
        self.vocab = [x.strip() for x in open('data/ubuntu_corpus_v1/ubuntu_sp_0.9995.vocab', 'r', encoding='utf-8').readlines()]
    ...
    def create_training_instances(self, input_file, max_seq_length,
        ...
        with open(input_file, "r", encoding="utf=8") as fr_handle:
            for line in tqdm(fr_handle):
                ...
                tokens = self.sp_tokenizer.encode(line, out_type=str)
    ...
    def instance_to_example_feature(self, instances, max_seq_length, max_predictions_per_seq):
        for instance in instances:
            input_ids = self.sp_tokenizer.piece_to_id(instance.tokens)
            ...
            masked_lm_ids = self.sp_tokenizer.piece_to_id(instance.masked_lm_labels)
