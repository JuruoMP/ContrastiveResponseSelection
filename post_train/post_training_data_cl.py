...
from post_train.pretrained_dpt_data_cl import BertDPTDataCL, ElectraDPTDataCL, ElectraNSPDPTDataCL
from models.utils.checkpointing import CheckpointManager, load_checkpoint


class PostTrainingDataCL(object):
    ...
    def _build_dataloader(self):
        ...
        self.train_dataset = training_dataset_map[self.pretrained_type](self.hparams, split="train",
                                                                        data_file="%s_post_training_cl.hdf5" % self.hparams.task_name)
    ...
    def _build_model(self):
        ...
        training_model_map = {
            "bert": BertDPTDataCL,
            "electra": ElectraDPTDataCL,
            "electra-nsp": ElectraNSPDPTDataCL
        }
