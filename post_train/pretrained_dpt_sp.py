...
class BertDPT(nn.Module):
    ...
    def forward(self, batch):
        ...
        mlm_loss, nsp_loss, prediction_scores, seq_relationship_score, cls_vector = bert_outputs[:5]
        fp_loss = self.classification_criterion(self.classification(cls_vector), batch['next_type'].squeeze(1))

        return None, mlm_loss, nsp_loss, fp_loss
