    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if state_dict is None and not from_tf:
            try:
                ...
                if resolved_archive_file.endswith('.bin'):
                ...
                if resolved_archive_file.endswith('.pth'):
                    for state_key in state_dict["model"].keys():
                        ...
                        if state_key.startswith("_electra_disc.electra."):
                            state_dict[state_key[len("_electra_disc.electra."):]] = state_dict["model"][state_key]
